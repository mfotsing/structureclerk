  ...
  const plans: Plan[] = [
    {
      ...
      features: t('plans.free.features') as unknown as string[],
      cta: t('plans.free.cta'),
    },
    {
      id: 'pro',
      name: t('plans.pro.name'),
      price: billingCycle === 'annual' ? '$10' : t('plans.pro.price'),
      period: billingCycle === 'annual' ? '/month' : t('plans.pro.period'),
      description: t('plans.pro.description'),
      popular: true,
      features: t('plans.pro.features') as unknown as string[],
      cta: t('plans.pro.cta'),
    },
    {
      id: 'business',
      name: t('plans.business.name'),
      price: billingCycle === 'annual' ? '$20' : t('plans.business.price'),
      period: billingCycle === 'annual' ? '/month' : t('plans.business.period'),
      description: t('plans.business.description'),
      features: t('plans.business.features') as unknown as string[],
      cta: t('plans.business.cta'),
    },
    {
      id: 'teams',
      name: t('plans.teams.name'),
      price: billingCycle === 'annual' ? '$45' : t('plans.teams.price'),
      period: billingCycle === 'annual' ? '/month + $9/user' : t('plans.teams.period'),
      description: t('plans.teams.description'),
      features: t('plans.teams.features') as unknown as string[],
