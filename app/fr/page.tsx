        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="flex space-x-8">
              <Link href="/fr/contact" className="text-gray-700 hover:text-blue-600">
                Contact
              </Link>
              <Link href="/fr/pricing" className="text-gray-700 hover:text-blue-600">
                Tarifs
              </Link>
              <Link href="/en" className="text-blue-600 font-medium">
                English
              </Link>
            </nav>
          </div>
