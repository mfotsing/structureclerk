...
# Fix apostrophes and quotes in all files
echo "Fixing entities in dashboard files..."
...
# Landing page files
sed -i '' "s/StructureClerk/StructureClerk/g" src/app/page.tsx
...
# Mobile demo
sed -i '' "s/J'utilise StructureClerk directement sur mes chantiers. Je prends une photo d'une facture et je sais immédiatement si ça affecte mon budget. Plus besoin d'attendre de rentrer au bureau./J&rsquo;utilise StructureClerk directement sur mes chantiers. Je prends une photo d&rsquo;une facture et je sais immédiatement si ça affecte mon budget. Plus besoin d&rsquo;attendre de rentrer au bureau./" src/components/landing/MobileDemo.jsx
