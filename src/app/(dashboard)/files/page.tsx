                ...
                {uploading || processing ? (
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-lg text-ui-text-muted">
                      (Factures, Soumissions, Reçus). L(Factures, Soumissions, Reçus). L(Factures, Soumissions, Reçus). L'IA fait le reste.rsquo;IA fait le reste.rsquo;IA fait le reste.
                    </p>
        ...
        <div className="space-y-4">
          <Card variant="default" padding="lg">
            <CardHeader>
              ...
              <CardDescription>
                Documents traités par lDocuments traités par lDocuments traités par l'IArsquo;IArsquo;IA
              </CardDescription>
            </CardHeader>
            <CardContent>
